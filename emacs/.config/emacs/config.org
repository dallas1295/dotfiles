...
#+begin_src emacs-lisp
  ...
  (use-package eglot
    ...
    (defun my/toggle-diagnostics-for-meow (_state)
     "Toggle flymake end-of-line diagnostics based on meow state."
     (setq flymake-show-diagnostics-at-end-of-line
         (when (meow-normal-mode-p) 'long))
     (when flymake-mode
         (flymake-mode -1)
         (flymake-mode 1)))
    (add-hook 'meow-switch-state-hook #'my/toggle-diagnostics-for-meow)
    (add-hook 'eglot--managed-mode-hook (lambda () (inlay-hints-mode -1)))
